...
namespace IISBackend.DAL.Migrations
{
    ...
    [Migration("20241123224910_added-animal-status")]
    partial class addedanimalstatus
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IISBackend.DAL.Entities.AnimalStatusEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("IISBackend.DAL.Entities.VerificationRequestEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("IISBackend.DAL.Entities.AnimalStatusEntity", b =>
                {
                    b.HasOne("IISBackend.DAL.Entities.AnimalEntity", "Animal")
                        .WithMany("AnimalStatusRecords")
                        .HasForeignKey("AnimalId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("IISBackend.DAL.Entities.UserEntity", "AssociatedUser")
                        .WithMany()
            ...
            modelBuilder.Entity("IISBackend.DAL.Entities.VerificationRequestEntity", b =>
                {
                    b.HasOne("IISBackend.DAL.Entities.UserEntity", "Requestee")
                        ...
                        .HasForeignKey("IISBackend.DAL.Entities.VerificationRequestEntity", "RequesteeID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("IISBackend.DAL.Entities.AnimalEntity", b =>
                {
                    b.Navigation("AnimalStatusRecords");
